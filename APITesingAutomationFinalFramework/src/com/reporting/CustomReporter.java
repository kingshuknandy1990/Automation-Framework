...
public class CustomReporter {
	...
	static {object = new ExtentReports("BeallsExecutionReport.html", true);}
...
//		childLogDesc = new Stack<String>();
	...
	{   /* ExcelLibrary exe=new ExcelLibrary(System.getProperty("user.dir")+"\\Bealls_Execution_Excel_CVCC.xlsx");
		String Environment=(String) exe.getCellData("TestData", 1, 1);
		String Browser=(String) exe.getCellData("TestData", 0, 1);
	    object.addSystemInfo("Environvent:",Environment );
