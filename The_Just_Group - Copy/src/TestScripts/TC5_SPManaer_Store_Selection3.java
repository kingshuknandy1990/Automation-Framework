...
public class TC5_SPManaer_Store_Selection3 {
	...
	public TC5_SPManaer_Store_Selection3()throws Exception{
...
//    	gs.writePassLog(gs.getText("//*[@id='B2FGridWrapper']/div/div[1]/a"));
        ...
        if(rs.failcounter>0){        	
        	...
        	CustomReporter.end();
 			...
 			CustomReporter.startParent("Test Case 5", "Verifying store selection");
